export const isCardValid = (cardNumber) => {
    return isFirstNumValid(cardNumber) && isCorrectNumLength(cardNumber) && isCardBankTypeNumValid(cardNumber)
}
 ...
 */
export const yupIsValidCardNumber = function (message) {
    return this.test({
...
export const yupIsExpireDateValid = function (message) {
    return this.test({
        name: 'isExpireDateValid',
        message: message,
        test: (value) => {
