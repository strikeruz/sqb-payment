		...
		<>
			{loading
                ...
                <div>
                    ...
                    <FormButtonItem label={ t('payment.continue') } className='inline-list-btn' onClick={() => history.push(`${url}/smsconfirm`)} />
                </div>
            }
		</>
	);
...
export default SecondCheckUserInfo